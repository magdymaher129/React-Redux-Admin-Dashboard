...
function AddProducts() {
  ...
  const AddProduct = async (e) => {
    ...
    // if (values) {
    //   select = values.map((value) => value.id);
    //   // console.log(select);
    // }
    // if (selectedColor) {
    //   select = selectedColor.map((value) => value.id);
    //   console.log(select);
    // }
        ...
        <div className={styles.brandUpdateContainer}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {data ? (
              ...
              // <img
              //   src={`${url}${data.multipleUpload[1].data.attributes.url}`}
              //   alt='gallery'
              //   width={300}
              //   height={450}
              //   style={{ margin: "30px 100px 20px 100px", borderRadius: "20px" }}
              // />
              <div
                style={{
                  margin: "auto",
